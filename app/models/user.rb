class User < ActiveRecord::Base
  ...
  def profile_picture_url_big
    url = profile_picture.url(:big)
    profile_picture.present? ? profile_picture.url(:big) : "/assets/missing.jpg"
  end

  def profile_picture_url_small
    profile_picture.present? ? profile_picture.url(:small) : "/assets/missing.jpg"
  end

  def cover_picture_url
    cover_picture.present? ? cover_picture.url(:big) : "/assets/cover-missing.jpg"
  end
